...
import com.abetterway.databinding.ActivityBusinessContactsBinding
import com.abetterway.databinding.ActivityTutorContactsBinding
import com.google.android.material.button.MaterialButton
import com.google.android.material.textfield.TextInputEditText

class BusinessContactsActivity : AppCompatActivity() {

    // create binding first
    private lateinit var binding: ActivityBusinessContactsBinding
    // creating adapter
    private var adapter = ContactAdapter()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBusinessContactsBinding.inflate(layoutInflater)
        setContentView(binding.root)
        setUpData(binding)

        // Action Bar
        actionBar?.title = "Business Contact Lists"
        supportActionBar?.title = "Business Contact Lists"

    }

    // Set up recyclerview
    fun setUpData(binding: ActivityBusinessContactsBinding) {
        binding.businessRecyclerView.adapter = adapter

        // item decoration
        binding.businessRecyclerView.addItemDecoration(DividerItemDecoration(this, LinearLayout.VERTICAL))
